// DecompilerFi decompiler from Assembly-CSharp-firstpass.dll class: UnityStandardAssets.ImageEffects.SunShafts
using UnityEngine;
...
namespace UnityStandardAssets.ImageEffects
{
	...
	public class SunShafts : PostEffectsBase
	{
		...
		private void OnRenderImage(RenderTexture source, RenderTexture destination)
		{
			...
			vector = (sunTransform ? GetComponent<Camera>().WorldToViewportPoint(sunTransform.position) : new Vector3(0.5f, 0.5f, 0f));
