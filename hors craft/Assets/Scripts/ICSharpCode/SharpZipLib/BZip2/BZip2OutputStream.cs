// DecompilerFi decompiler from Assembly-CSharp.dll class: ICSharpCode.SharpZipLib.BZip2.BZip2OutputStream
	...
	public class BZip2OutputStream : Stream
	{
		...
		private void QSort3(int loSt, int hiSt, int dSt)
		{
			...
			while (num > 0)
			{
				...
				num7 = ((num3 - ll >= num4 - num3) ? (num4 - num3) : (num3 - ll));
				Vswap(ll, num4 - num7, num7);
				int num11 = (hh - num5 >= num5 - num6) ? (num5 - num6) : (hh - num5);
		...
		private static void HbMakeCodeLengths(char[] len, int[] freq, int alphaSize, int maxLen)
		{
			...
			while (true)
			{
				...
				while (num2 > 1)
				{
					...
					array2[num] = ((int)((array2[num5] & 4294967040u) + (array2[num9] & 4294967040u)) | (1 + (((array2[num5] & 0xFF) <= (array2[num9] & 0xFF)) ? (array2[num9] & 0xFF) : (array2[num5] & 0xFF))));
					array3[num] = -1;
					num2++;
					array[num2] = num;
					num6 = num2;
