// DecompilerFi decompiler from Assembly-CSharp.dll class: Common.GameUI.SimpleRepeatArea
using UnityEngine;
...
{
	public class SimpleRepeatArea : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IEventSystemHandler
	{
