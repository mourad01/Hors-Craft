// DecompilerFi decompiler from Assembly-CSharp.dll class: Common.MiniJSON.Json
using System;
	...
	public static class Json
	{
		private sealed class Parser : IDisposable
		{
			...
			private object ParseNumber()
			{
				...
				double.TryParse(nextWord, NumberStyles.Any, CultureInfo.InvariantCulture, out double result2);
				return result2;
			}
