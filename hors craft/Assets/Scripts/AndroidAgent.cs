// DecompilerFi decompiler from Assembly-CSharp.dll class: AndroidAgent
...
/*public class AndroidAgent : IronSourceIAgent
{
	...
	{
		return getBridge().Call<string>("getAdvertiserId", Array.Empty<object>());
	}
	...
	{
		return getBridge().Call<bool>("isRewardedVideoAvailable", Array.Empty<object>());
	}
	...
	{
		return getBridge().Call<bool>("isOfferwallAvailable", Array.Empty<object>());
	}
