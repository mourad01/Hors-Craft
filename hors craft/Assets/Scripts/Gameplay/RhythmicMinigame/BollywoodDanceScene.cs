// DecompilerFi decompiler from Assembly-CSharp.dll class: Gameplay.RhythmicMinigame.BollywoodDanceScene
...
{
	public class BollywoodDanceScene : RhythmReactor
	{
		...
		public BollywoodDanceScene(PlayerGraphic playerGraphic, RuntimeAnimatorController newPlayerAnimatorController, Transform humanPivot, HashSet<HumanMob> mobs, AudioClip[] successClips, GameObject[] gosToHideInGame)
		{
		...
		private void CameraOnPlayer()
		{
			...
			lookAtTargetMotor.Offset = 1.75f * playerAnimator.transform.forward + new Vector3(0f, 0f, -2f);
		...
		private void CameraOnMobs()
		{
			...
			LookAtTargetMotor lookAtTargetMotor = (LookAtTargetMotor)CameraController.instance.ActiveMotor;
			lookAtTargetMotor.Target = playerAnimator.transform;
			lookAtTargetMotor.Offset = -2f * playerAnimator.transform.forward + new Vector3(0f, 0f, 1.5f);
			lookAtTargetMotor.TargetOffset = new Vector3(0f, 0f, 0f);
			lookAtTargetMotor.UseCurrentPosition = false;
		}
