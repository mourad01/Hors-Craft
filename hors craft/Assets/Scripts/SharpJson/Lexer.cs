// DecompilerFi decompiler from Assembly-CSharp.dll class: SharpJson.Lexer
using System;
...
namespace SharpJson
{
	internal class Lexer
	{
		...
		public float ParseFloatNumber()
		{
			...
			if (!float.TryParse(numberString, NumberStyles.Any, CultureInfo.InvariantCulture, out float result))
			{
				return 0f;
			}
			return result;
