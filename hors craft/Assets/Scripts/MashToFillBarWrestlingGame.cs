// DecompilerFi decompiler from Assembly-CSharp.dll class: MashToFillBarWrestlingGame
using Common.Managers;
using Gameplay;
using UnityEngine;

public class MashToFillBarWrestlingGame : TappingGameBehaviour
{
	...
	public MashToFillBarWrestlingGame(AnimationCurve[] behaviours, float tap = 5f, float opponentCD = 0.1f, float defaultProgress = 50f)
	{
		tapStrnegth = tap;
