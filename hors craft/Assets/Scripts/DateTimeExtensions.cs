// DecompilerFi decompiler from Assembly-CSharp.dll class: DateTimeExtensions
using System;
...
public static class DateTimeExtensions
{
	...
	{
		return new DateTime(value.Year, value.Month, 1).AddMonths(1).AddDays(-1.0);
	}
	...
	public static long GetDecadesSince(this DateTime time)
	{
		...
		return (yearsSince / 10).AbsoluteValue();
	}

	public static long GetCenturiesSince(this DateTime time)
	{
		long yearsSince = time.GetYearsSince();
		return (yearsSince / 100).AbsoluteValue();
	}
