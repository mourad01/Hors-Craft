// DecompilerFi decompiler from Assembly-CSharp.dll class: GooglePlayGames.PlayGamesLocalUser
...
namespace GooglePlayGames
{
	public class PlayGamesLocalUser : PlayGamesUserProfile, ILocalUser, IUserProfile
	{
		...
		public void GetStats(Action<CommonStatusCodes, GooglePlayGames.BasicApi.PlayerStats> callback)
		{
			...
			{
				mPlatform.GetPlayerStats(delegate(CommonStatusCodes rc, GooglePlayGames.BasicApi.PlayerStats stats)
				{
					mStats = stats;
					callback(rc, stats);
				});
