// DecompilerFi decompiler from Assembly-CSharp.dll class: GooglePlayGames.OurUtils.Logger
using System;
using UnityEngine;
	...
	public class Logger
	{
		...
		public static void d(string msg)
		{
			if (debugLogEnabled)
			{
				...
				{
					UnityEngine.Debug.Log(ToLogMessage(string.Empty, "DEBUG", msg));
				});
			}
		}
		...
		public static void w(string msg)
		{
			if (warningLogEnabled)
			{
				PlayGamesHelperObject.RunOnGameThread(delegate
				{
					UnityEngine.Debug.LogWarning(ToLogMessage("!!!", "WARNING", msg));
				});
			}
		}
		...
		public static void e(string msg)
		{
			if (warningLogEnabled)
			{
				PlayGamesHelperObject.RunOnGameThread(delegate
				{
					UnityEngine.Debug.LogWarning(ToLogMessage("***", "ERROR", msg));
				});
			}
		}
