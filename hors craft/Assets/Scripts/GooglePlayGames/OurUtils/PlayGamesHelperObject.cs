// DecompilerFi decompiler from Assembly-CSharp.dll class: GooglePlayGames.OurUtils.PlayGamesHelperObject
using System;
	...
	public class PlayGamesHelperObject : MonoBehaviour
	{
		...
		public void OnApplicationFocus(bool focused)
		{
			foreach (Action<bool> sFocusCallback in sFocusCallbackList)
			{
				...
				{
					UnityEngine.Debug.LogError("Exception in OnApplicationFocus:" + ex.Message + "\n" + ex.StackTrace);
				}
			}
		}
		...
		public void OnApplicationPause(bool paused)
		{
			foreach (Action<bool> sPauseCallback in sPauseCallbackList)
			{
				...
				{
					UnityEngine.Debug.LogError("Exception in OnApplicationPause:" + ex.Message + "\n" + ex.StackTrace);
				}
			}
		}
