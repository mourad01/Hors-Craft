// DecompilerFi decompiler from Assembly-CSharp.dll class: GooglePlayGames.PlayGamesPlatform
...
namespace GooglePlayGames
{
	public class PlayGamesPlatform : ISocialPlatform
	{
		...
		public void GetPlayerStats(Action<CommonStatusCodes, GooglePlayGames.BasicApi.PlayerStats> callback)
		{
			...
			callback(CommonStatusCodes.SignInRequired, new GooglePlayGames.BasicApi.PlayerStats());
		}
