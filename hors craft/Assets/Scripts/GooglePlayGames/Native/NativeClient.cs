// DecompilerFi decompiler from Assembly-CSharp.dll class: GooglePlayGames.Native.NativeClient
	...
	public class NativeClient : IPlayGamesClient
	{
		...
		private void InitializeTokenClient()
		{
			if (mTokenClient == null)
			{
				...
				string[] scopes = mConfiguration.Scopes;
				mTokenClient.SetWebClientId("596292033504-j3vvhh9cpmofe1pag0f9sjcum8vr1ip5.apps.googleusercontent.com");
