// DecompilerFi decompiler from Assembly-UnityScript.dll class: RotationConstraint
using System;
using UnityEngine;
...
public class RotationConstraint : MonoBehaviour
{
	...
	public void Start()
	{
		...
		Quaternion lhs = Quaternion.AngleAxis(thisTransform.localRotation.eulerAngles[(int)axis], rotateAround);
