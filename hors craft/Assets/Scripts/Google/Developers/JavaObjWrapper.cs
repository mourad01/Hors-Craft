// DecompilerFi decompiler from Assembly-CSharp.dll class: Google.Developers.JavaObjWrapper
using System;
	...
	public class JavaObjWrapper
	{
		...
		protected static jvalue[] ConstructArgArray(object[] theArgs)
		{
			...
			if (array2.Length == 1)
			{
				...
				{
					UnityEngine.Debug.Log("---- [" + k + "] -- " + array2[k].l);
				}
			}
			return array2;
		}
		...
		public static T StaticInvokeObjectCall<T>(string type, string name, string sig, params object[] args)
		{
			...
			UnityEngine.Debug.Log("Trying cast....");
		...
		public T InvokeCall<T>(string name, string sig, params object[] args)
		{
			...
			{
				UnityEngine.Debug.LogError("Cannot get method for " + name);
