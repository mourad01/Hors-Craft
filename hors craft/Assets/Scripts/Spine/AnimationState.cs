// DecompilerFi decompiler from Assembly-CSharp.dll class: Spine.AnimationState
using System;
	...
	public class AnimationState
	{
		...
		private void AnimationsChanged()
		{
			...
			for (int count = tracks.Count; i < count; i++)
			{
				...
				if (trackEntry != null)
				{
					trackEntry.SetTimelineData(to, mixingToArray, hashSet);
					to = trackEntry;
				}
			}
		}
