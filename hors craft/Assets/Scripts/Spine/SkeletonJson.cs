// DecompilerFi decompiler from Assembly-CSharp.dll class: Spine.SkeletonJson
using System;
	...
	public class SkeletonJson
	{
		...
		private Attachment ReadAttachment(Dictionary<string, object> map, Skin skin, int slotIndex, string name, SkeletonData skeletonData)
		{
			...
			case AttachmentType.Clipping:
			{
				...
				SlotData slotData = skeletonData.FindSlot(GetString(map, "end", null));
				if (slotData == null)
				{
					throw new Exception("Clipping end slot not found: " + GetString(map, "end", null));
				}
