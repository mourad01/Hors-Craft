// DecompilerFi decompiler from Assembly-CSharp.dll class: Spine.Unity.MeshGenerator
using System;
...
namespace Spine.Unity
{
	...
	public class MeshGenerator
	{
		...
		public Vector3[] VertexBuffer => vertexBuffer.Items;

		public Vector2[] UVBuffer => uvBuffer.Items;

		public Color32[] ColorBuffer => colorBuffer.Items;
		...
		public static void GenerateSkeletonRendererInstruction(SkeletonRendererInstruction instructionOutput, Skeleton skeleton, Dictionary<Slot, Material> customSlotMaterials, List<Slot> separatorSlots, bool generateMeshOverride, bool immutableTriangles = false)
		{
			...
			for (int i = 0; i < count; i++)
			{
				...
				if (flag3)
				{
					if (submeshInstruction2.forceSeparate && generateMeshOverride && submeshInstruction2.rawVertexCount > 0)
					{
