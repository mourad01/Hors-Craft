// DecompilerFi decompiler from Assembly-CSharp.dll class: Spine.Unity.AtlasAsset
using System;
...
namespace Spine.Unity
{
	public class AtlasAsset : ScriptableObject
	{
		...
		public static AtlasAsset CreateRuntimeInstance(TextAsset atlasText, Texture2D[] textures, Material materialPropertySource, bool initialize)
		{
			...
			AtlasAsset atlasAsset = CreateRuntimeInstance(atlasText, textures, shader, initialize);
			Material[] array = atlasAsset.materials;
