// DecompilerFi decompiler from Assembly-CSharp.dll class: Com.Google.Android.Gms.Common.Api.GoogleApiClient
...
namespace Com.Google.Android.Gms.Common.Api
{
	public class GoogleApiClient : JavaObjWrapper
	{
		...
		{
			return InvokeCall<ConnectionResult>("blockingConnect", "(JLjava/util/concurrent/TimeUnit;)Lcom/google/android/gms/common/ConnectionResult;", new object[2]
			{
				arg_long_1,
				arg_object_2
			});
		...
		{
			return InvokeCall<ConnectionResult>("getConnectionResult", "(Lcom/google/android/gms/common/api/Api;)Lcom/google/android/gms/common/ConnectionResult;", new object[1]
			{
				arg_object_1
			});
		}
		...
		{
			return InvokeCall<bool>("isConnectionCallbacksRegistered", "(Lcom/google/android/gms/common/api/GoogleApiClient$ConnectionCallbacks;)Z", new object[1]
			{
				arg_object_1
			});
		}
		...
		{
			return InvokeCall<bool>("isConnectionFailedListenerRegistered", "(Lcom/google/android/gms/common/api/GoogleApiClient$OnConnectionFailedListener;)Z", new object[1]
			{
				arg_object_1
			});
		}
		...
		{
			return InvokeCall<bool>("hasConnectedApi", "(Lcom/google/android/gms/common/api/Api;)Z", new object[1]
			{
				arg_object_1
			});
		}
