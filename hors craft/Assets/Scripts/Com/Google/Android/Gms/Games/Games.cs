// DecompilerFi decompiler from Assembly-CSharp.dll class: Com.Google.Android.Gms.Games.Games
...
namespace Com.Google.Android.Gms.Games
{
	public class Games : JavaObjWrapper
	{
		...
		{
			return JavaObjWrapper.StaticInvokeCall<string>("com/google/android/gms/games/Games", "getAppId", "(Lcom/google/android/gms/common/api/GoogleApiClient;)Ljava/lang/String;", new object[1]
			{
