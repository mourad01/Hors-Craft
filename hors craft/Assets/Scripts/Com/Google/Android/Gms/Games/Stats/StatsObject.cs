// DecompilerFi decompiler from Assembly-CSharp.dll class: Com.Google.Android.Gms.Games.Stats.StatsObject
...
namespace Com.Google.Android.Gms.Games.Stats
{
	public class StatsObject : JavaObjWrapper, Stats
	{
		...
		{
			IntPtr ptr = InvokeCall<IntPtr>("loadPlayerStats", "(Lcom/google/android/gms/common/api/GoogleApiClient;Z)Lcom/google/android/gms/common/api/PendingResult;", new object[2]
			{
